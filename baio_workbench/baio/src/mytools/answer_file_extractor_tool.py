...
#######
loader = TextLoader( ./BLAST_results_NTC1DYCC016.txt )
...
files_to_process = [f for f in os.listdir( ./baio/data/persistant_files/evaluation/blast_question_answers/ ) if f.startswith( BLAST_results_ ) and f.endswith( .txt )]
...
#store answers
answers =
directory =  ./baio/data/persistant_files/evaluation/blast_question_answers/
...
import json
with open( ./baio/data/persistant_files/evaluation/geneturing.json , r ) as file:
  data = json.load(file)
...
with open( ./baio/data/persistant_files/user_manuals/api_documentation/ucsc/genomes.json , r ) as file:
  data = json.load(file)
...
csv_file =  ./baio/data/persistant_files/user_manuals/api_documentation/ucsc/ucsc_genomes_converted.csv
...
# File paths
input_file =  ./baio/data/persistant_files/user_manuals/api_documentation/ucsc/ucsc_genomes_converted.csv
output_file =  ./baio/data/persistant_files/user_manuals/api_documentation/ucsc/ucsc_genomes_reduced.csv
...
with open('./baio/data/output/geneturing_eutils_281123/logfile_snp.json', 'r') as file:
...
with open('./snp_log_with_type_answers.json', 'w') as file:
    json.dump(data1, file, indent=4)
import json
import csv

# Load the modified JSON data
with open('./snp_log_with_type_answers.json', 'r') as file:
    data = json.load(file)

# Define the CSV file name
csv_file = './snp_ans.csv'
